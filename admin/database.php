                            ...
                            <form method="POST">
                                <div class="form-group text-center option">
                                    ...
                                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%" tabindex="-1" aria-hidden="true" class="input" name="company">
                                        <option value="" selected>Selec Company</option>
                                        <?php
                                         $companies = ["Tech Innovators Inc.", "Global Solutions Ltd.", "Alpha Dynamics", "Beta Tech Corp.", "Delta Systems", "Epsilon Enterprises", "Zeta Industries", "Omega Technologies", "Phoenix Solutions", "Orion Tech Group"];
